 ...
 */
public class Barrel extends Tower
{
    /**
    ...
    public void act() 
    {
        ...
        followMouse();
        if (isTowerClicked == false && isTowerPlaced == true)
        {
            getTarget();
        }
    ...
    public boolean checkBarrelIsPlaced()
    {
