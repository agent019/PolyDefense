...
public class Enemy4 extends Enemy
{
    ...
    public void imageOne()
    {
        ...
        if( world instanceof Background1)
        {
            ...
            if (waypointPassed == 0 ){
                setImage("Zombie(4)1.png"); 
                imageTimerCountInitial();
            }
            if (waypointPassed == 1) {
                setImage("Zombie(4)7.png"); 
                imageTimerCount2();
            }
            if (waypointPassed == 2) {
                setImage("Zombie(4)1.png"); 
    ...
    public void imageTimerCountInitial()
    {
        ...
        if (timer == 5) 
        {
            setImage("Zombie(4)2.png"); 
        }
        if (timer == 3) 
        {
            setImage("Zombie(4)3.png");
        }
        if (timer == 0) {
            imageTimer(); }
    }
    ...
    public void imageTimerCount2()
    {
        ...
        if (timer == 5) 
        {
            setImage("Zombie(4)8.png"); 
        }
        if (timer == 3) 
        {
            setImage("Zombie(4)9.png");
        }
        if (timer == 0) {
            imageTimer(); } 
    }
    ...
    public void imageTimerCount4()
    {
        ...
        if (timer == 5) 
        {
            setImage("Zombie(4)5.png"); 
        }
        if (timer == 3) 
        {
            setImage("Zombie(4)6.png");
        }
        if (timer == 0) {
            imageTimer(); } 
    }
    ...
    public void imageTimerCount5()
    {
        ...
        if (timer == 5) 
        {
            setImage("Zombie(4)11.png"); 
        }
        if (timer == 3) 
        {
            setImage("Zombie(4)12.PNG");
        }
        if (timer == 0) {
            imageTimer(); } 
    }
